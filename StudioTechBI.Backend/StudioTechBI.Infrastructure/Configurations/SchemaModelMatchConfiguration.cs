...
public class SchemaModelMatchConfiguration : IEntityTypeConfiguration<SchemaModelMatch>
{
    public void Configure(EntityTypeBuilder<SchemaModelMatch> builder)
    {
        builder.ToTable("SchemaModelMatches");
